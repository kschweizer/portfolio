                ...
                <Accordion.Body>
                    <Container className="border1">
                        ...
                        <Card bg="transparent" text="white">
                            ...
                            <Card.Body >
                                <p className="text-align-left" style={{ marginBottom : '75px' }}> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Project for Software Engineering (CS169). The goals of the course were to teach
                                ...
                                <CustomToggle eventKey="yt-1">{demoVisible ? "Hide Demo Video" : "Show Demo Video"}</CustomToggle> 
                            <Accordion.Collapse eventKey="yt-1">
                ...
                <Accordion.Body>
                    <Container className="border3">
                        <Card bg="transparent" text="white">
                            ...
                            <Card.Body>
                                <p>
                                Project for Data Structures (CS61B). The task was to build a relational database management system (RDBMS) that uses a domain specific language (DSL) similar to that of
                ...
                <Accordion.Body>
                    <Container className="border2">
                        <Card bg="transparent" text="white">
                            ...
                            <Card.Body>
                                <p>Project for Algorithms (CS170). The goal of this project was to design an algorithm that finds a reasonable solution to an NP-Hard graph-traversal problem. I worked with one other student 
